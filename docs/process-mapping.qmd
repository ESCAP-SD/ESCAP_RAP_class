...
The Eurostat publication "[Practical guidelines on web scraping for the HICP (2020)](https://ec.europa.eu/eurostat/documents/272892/12032198/Guidelines-web-scraping-HICP-11-2020.pdf/)" outlines several key steps necessary to calculate elementary aggregates. 

::: callout-note
This section is still under construction
:::

Bulk vs targeted scraping - this will impact all upstream steps as the scraper works differently, data processing step may be less onerous, and the classification step may not be needed (as classification is inherently taken care of with targeted scraping).
...
Apart from all the details above, we know that general recommendations for web scraping are:
