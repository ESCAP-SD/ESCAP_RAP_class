...
To develop a robust RAP implementation of the webscraping component, we should first go through the downstream steps in order to fully understand them and formulate all applicable requirements.
...
Integration / Aggregation structures

### Classification close up

### Data processing close up

### Requirements for the web scraping step