...
## The [basic process demoed in the scraping walkthrough](/notebooks/scraping_experiment.ipynb)

While its separated into a collection of the URLs for each product and the extraction and parsing of all content on each product page to save this in the previous walkthrough, we can visualize the overall process as a set of calls to get the data, a set of logical steps, and a set of parsing and actions of various kinds to get the data we need:
