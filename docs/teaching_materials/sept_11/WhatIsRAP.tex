...
\begin{frame}{Why are Reproducible Analytical Pipelines good for you?}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{itemize}[<+->]
        \item It will make your (and your team's) (\emph{working}) life easier. For example way less confusion about where things are and how it works! Lower cognitive load on day to day tasks!
