...
\begin{frame}{Why are Reproducible Analytical Pipelines good for you?}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{itemize}[<+->]
        \item It will make your (\emph{working}) life easier
        \item It is a satisfying way to work
        \item It is a time-saver
        \item It helps tracking mistakes
        \item It helps collaborating
        \item It will enhance your skills (and make you famous?)
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
    \begin{itemize}
...
\begin{frame}{What does a RAP look like?}
 \begin{center}
  \begin{itemize}
        ...
        \only<4>{\includegraphics[width=0.8\textwidth]{Pipeline4.png} \\ And only through code (Python, R, \emph{Stata}), no copy/paste }
  ...
  \begin{column}{0.8\textwidth}
    \begin{itemize}
        ...
        \only<4>{\scriptsize  \texttt{\# Defining a generic function} \\
                                ...
                                \texttt{     plt.show()}\\
                                \texttt{\# Applying function to several products} \\
