...
-   Try functional programming! This is key about learning technical skills to make your code more modular and efficient and is the next step to help organize code together!
-   Try creating `.py` scripts, making your code more robust for production and the next step from exploration!
-   Try git and peer review - first develop a notebook (or script) to do some scraping. Then commit it to a github repository and then ask someone to peer review it using a separate branch (and a pull request) or simply an issue - to create transparency.
