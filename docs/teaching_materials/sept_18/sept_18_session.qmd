...
This excercize may take you some time to walk through - so it's probably best not to rush it. However there are several Steps to follow:
...
2.  As the above example did not have a copy of the code locally, we can try to clone (i.e. create a local copy) of the repository to your local computer. Again, please follow this GitHub how-to - <https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository>.
3.  ...
